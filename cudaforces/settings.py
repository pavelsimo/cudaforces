...
# Guest sign-in is a dev convenience: available exactly when email is unconfigured,
# the same signal the mailer uses to log codes instead of sending them.
GUEST_LOGIN_ENABLED = not SMTP_ADDRESS
